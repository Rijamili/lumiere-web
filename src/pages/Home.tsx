    ...
    <div>
      <section className="relative min-h-[560px] flex items-center">
        <div
          ...
          style={{ backgroundImage: "url(https://picsum.photos/seed/lumiere-hero/1600/900)" }}
        />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
          {CATEGORIES.map((c) => (
            <div
              ...
              className="card cursor-pointer text-center fade-in"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {PROS.map((p) => (
            <div key={p.id} className="card p-6 text-center">
              <img src={p.img} className="w-21 h-21 w-[84px] h-[84px] rounded-full object-cover mx-auto mb-3.5" />
      ...
      <section className="max-w-6xl mx-auto px-6 pt-14 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {SALONS.map((s) => (
            <div key={s.id} onClick={() => navigate(`/salon/${s.id}`)} className="card cursor-pointer">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-14 pb-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {OFFERS.map((o, i) => (
            <div key={i} className="card p-5 bg-charcoal text-cream border-none">
